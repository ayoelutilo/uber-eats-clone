    ...
    return (
        <Container fluid>
            <Row variant="warning" style={{ backgroundColor: "#122329" }} >
                ...
                <Col xs={12} sm={4} className="my-4 py-4 ml-n4 px-4 margin-left rounded" style={{ backgroundColor: "#E2F3DD" }}>
                ...
                <Col xs={12} sm={4} className="my-4 py-4 ml-4 px-4 margin-left rounded" style={{ backgroundColor: "#FDEED1", color: "#122427", borderWidth: "8px !important" }}>
